...
module.exports = (client, message) => {
    ...
    .addField("Autor ", `${message.author.tag} (ID: ${message.author.id})`, true)
    .addField("Contenido del mensaje:", `${descriptionfix}`, true)
    .setTimestamp()
    .setFooter("Mensaje eliminado en " + message.channel.name);
